...
const infoMapping = {
  ...
  [_types.TypeDefInfo.Si]: (registry, value) => getTypeClass(registry, registry.lookup.getTypeDef(value.index)),
...
function getTypeClass(registry, value) {
  ...
  (0, _util.assert)(getFn, () => `Unable to construct class from ${(0, _util.stringify)(value)}`);
