const polkadotTypes = (function (exports, util, utilCrypto) {
  ...
  const definitions$V = {
    rpc: {},
    types: _objectSpread$s(_objectSpread$s({}, numberTypes), {}, {
  ...
  const definitions$v = {
    rpc: {},
    types: _objectSpread$r(_objectSpread$r({}, keyTypes), {}, {
  ...
  const definitions$t = {
    rpc: {},
    types: _objectSpread$q(_objectSpread$q(_objectSpread$q({}, deprecated), phragmen), {}, {
      ActiveEraInfo: {
        index: 'EraIndex',
        start: 'Option<Moment>'
      },
  ...
  const definitions$g = {
    rpc: {},
    types: _objectSpread$p({}, dmpQueue)
  };
  ...
  const slotTypes = _objectSpread$o(_objectSpread$o({}, oldTypes), {}, {
    AuctionIndex: 'u32',
  ...
  const definitions$f = {
    rpc: {},
    types: _objectSpread$n(_objectSpread$n(_objectSpread$n(_objectSpread$n(_objectSpread$n({}, cumulusTypes), hrmpTypes), proposeTypes), slotTypes), {}, {
  ...
  const definitions$c = {
    rpc: {},
    types: _objectSpread$m(_objectSpread$m(_objectSpread$m(_objectSpread$m(_objectSpread$m({}, junction), multiAsset), xcm), xmcOrder), {}, {
      DoubleEncodedCall: {
        encoded: 'Vec<u8>'
      },
      XcmOriginKind: {
  ...
  const definitions$b = {
    rpc: {},
    types: _objectSpread$l(_objectSpread$l(_objectSpread$l({}, layout), spec), {}, {
      ContractProject: {
  ...
  const definitions$a = {
    rpc: {},
    types: _objectSpread$k(_objectSpread$k({}, v0), {}, {
      SiField: {
        name: 'Option<Text>',
        type: 'SiLookupTypeId',
        typeName: 'Option<Text>',
  ...
  const rpc = _objectSpread$j(_objectSpread$j(_objectSpread$j({}, netRpc), web3Rpc), {}, {
    accounts: {
  ...
  class DoNotConstruct {
    constructor(registry, typeName = 'DoNotConstruct') {
      ...
      this.registry = registry;
      _classPrivateFieldBase(this, _neverError)[_neverError] = new Error(`Cannot construct unknown type ${typeName}`);
  ...
  const infoMapping = {
    ...
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    [exports.TypeDefInfo.Null]: (registry, _) => createClass(registry, 'Null'),
    ...
    [exports.TypeDefInfo.Si]: (registry, value) => getTypeClass(registry, registry.lookup.getTypeDef(value.index)),
  ...
  function getTypeClass(registry, value) {
    let Type = registry.get(value.type);
    ...
    util.assert(getFn, () => `Unable to construct class from ${util.stringify(value)}`);
    Type = getFn(registry, value); // don't clobber any existing
  ...
  function initType(registry, Type, params = [], {
    ...
    if (isPedantic) {
      if (util.isU8a(value)) {
        ...
        checkInstance(util.u8aToU8a(value), created);
      }
    }
  ...
  const encoders = {
    [exports.TypeDefInfo.BTreeMap]: typeDef => encodeWithParams(typeDef, 'BTreeMap'),
    [exports.TypeDefInfo.BTreeSet]: typeDef => encodeWithParams(typeDef, 'BTreeSet'),
    [exports.TypeDefInfo.Compact]: typeDef => encodeWithParams(typeDef, 'Compact'),
    [exports.TypeDefInfo.DoNotConstruct]: typeDef => encodeDoNotConstruct(typeDef),
    [exports.TypeDefInfo.Enum]: typeDef => encodeEnum(typeDef),
    [exports.TypeDefInfo.HashMap]: typeDef => encodeWithParams(typeDef, 'HashMap'),
    [exports.TypeDefInfo.Int]: typeDef => encodeUInt(typeDef, 'Int'),
    [exports.TypeDefInfo.Linkage]: typeDef => encodeWithParams(typeDef, 'Linkage'),
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    [exports.TypeDefInfo.Null]: typeDef => 'Null',
    [exports.TypeDefInfo.Option]: typeDef => encodeWithParams(typeDef, 'Option'),
    [exports.TypeDefInfo.Plain]: typeDef => typeDef.displayName || typeDef.type,
    [exports.TypeDefInfo.Result]: typeDef => encodeWithParams(typeDef, 'Result'),
    [exports.TypeDefInfo.Set]: typeDef => typeDef.type,
    [exports.TypeDefInfo.Si]: typeDef => typeDef.type,
    [exports.TypeDefInfo.Struct]: typeDef => encodeStruct(typeDef),
    [exports.TypeDefInfo.Tuple]: typeDef => encodeTuple(typeDef),
    [exports.TypeDefInfo.UInt]: typeDef => encodeUInt(typeDef, 'UInt'),
    [exports.TypeDefInfo.Vec]: typeDef => encodeWithParams(typeDef, 'Vec'),
    [exports.TypeDefInfo.VecFixed]: typeDef => encodeVecFixed(typeDef)
  };

  function encodeType(typeDef) {
    const encoder = encoders[typeDef.info];
    util.assert(encoder, () => `Cannot encode type: info=${typeDef.info}, typeDef=${util.stringify(typeDef)}`);
  ...
  class GenericPortableRegistry extends Struct {
    ...
    getTypeDef(lookupId) {
      const index = _classPrivateFieldBase(this, _getLookupId)[_getLookupId](lookupId);

      if (!_classPrivateFieldBase(this, _typeDefs)[_typeDefs][index]) {
        _classPrivateFieldBase(this, _typeDefs)[_typeDefs][index] = _classPrivateFieldBase(this, _extract)[_extract](this.getSiType(lookupId), index);
      }

      return _classPrivateFieldBase(this, _typeDefs)[_typeDefs][index];
    }
  ...
  function _extract2(type, lookupIndex) {
    ...
    try {
      if (isPrimitivePath) {
        typeDef = _classPrivateFieldBase(this, _extractPrimitivePath)[_extractPrimitivePath](lookupIndex, type);
        ...
        typeDef = _classPrivateFieldBase(this, _extractComposite)[_extractComposite](lookupIndex, type.def.asComposite);
      ...
      throw new Error(`PortableRegistry: Error extracting ${util.stringify(type)}: ${error.message}`);
    }

    const displayName = (_path$pop = path.pop()) === null || _path$pop === void 0 ? void 0 : _path$pop.toString();
    return _objectSpread$7(_objectSpread$7(_objectSpread$7({}, displayName ? {
      displayName
    } : {}), path.length > 1 ? {
  ...
  function _extractArray2(lookupIndex, {
    ...
    util.assert(!length || length.toNumber() <= 256, 'PortableRegistry: Only support for [Type; <length>], where length <= 256');
    return {
  ...
  function _extractComposite2(lookupIndex, {
    ...
    return _classPrivateFieldBase(this, _extractFields)[_extractFields](lookupIndex, fields);
  }
  ...
  function _extractFields2(lookupIndex, fields) {
    ...
    util.assert(isTuple || isStruct, 'PortableRegistry: Invalid fields type detected, expected either Tuple or Struct');
    ...
    if (isTuple) {
      if (fields.length === 0) {
        ...
        return _objectSpread$7(_objectSpread$7({}, _classPrivateFieldBase(this, _createSiDef)[_createSiDef](fields[0].type)), fields[0].name.isSome ? {
          name: util.stringCamelCase(fields[0].name.unwrap())
        } : {});
      }
    }
    ...
    const sub = fields.map(({
      name,
      type
    }) => _objectSpread$7(_objectSpread$7({}, _classPrivateFieldBase(this, _createSiDef)[_createSiDef](type)), name.isSome ? {
      name: util.stringCamelCase(name.unwrap())
    } : {}));
    return {
  ...
  function _extractTuple2(lookupIndex, ids) {
    return ids.length === 1 ? this.getTypeDef(ids[0]) : {
      ...
      sub: ids.map(type => _classPrivateFieldBase(this, _createSiDef)[_createSiDef](type)),
      type: this.registry.createLookupType(lookupIndex)
    };
  }
  ...
  function _extractVariant2(lookupIndex, {
    ...
    return specialVariant === 'Option' ? {
      ...
      sub: params.map((p, index) => _objectSpread$7({
        name: ['Ok', 'Error'][index]
      }, _classPrivateFieldBase(this, _createSiDef)[_createSiDef](p.type.unwrap()))),
      type: this.registry.createLookupType(lookupIndex)
    } : {
      info: exports.TypeDefInfo.Enum,
      sub: _classPrivateFieldBase(this, _extractVariantSub)[_extractVariantSub](lookupIndex, variants),
      type: this.registry.createLookupType(lookupIndex)
    };
  }
  ...
  function _extractVariantSub2(lookupIndex, variants) {
    return variants.every(({
      ...
      index,
      name
    }) => _objectSpread$7(_objectSpread$7({}, _classPrivateFieldBase(this, _extractFields)[_extractFields](lookupIndex, fields)), {}, {
      index: index.toNumber(),
      name: name.toString()
    }));
  }
  ...
  function injectErrors(_, metadata, metadataErrors) {
    ...
    modules.forEach((section, _sectionIndex) => {
      ...
      const sectionName = util.stringCamelCase(section.name);
