  ...
  _newType(registry, blockHash, key, input, isEmpty, entryIndex = -1) {
    ...
    try {
      if (meta.modifier.isOptional) {
        ...
        if (!isEmpty) {
          inner = (0, _types.createTypeUnsafe)(registry, type, [input], {
            blockHash,
            isPedantic: true
          });
        }

        const option = new _types.Option(registry, (0, _types.createClass)(registry, type), inner);
      ...
      return (0, _types.createTypeUnsafe)(registry, type, [isEmpty ? meta.fallback ? (0, _util.hexToU8a)(meta.fallback.toHex()) : undefined : input], {
        blockHash,
        isPedantic: true
      });
    } catch (error) {
